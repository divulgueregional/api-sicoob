# ALTERAR ABATIMENTOS BOLETO-SICOOB

## Alterar abatimentos
Serviço para alterar o valor de abatimento de boletos informados.<br>
...
```php
    ...
    $boleto = [
      ...
      "modalidade" => 1,
      "nossoNumero" => 1234,
      "valorAbatimento" => 20.65,
    ];
    $Boletos[] = $boleto;

    $reponse = $sicoob->abatimentosBoleto($Boletos);
    print_r($reponse);
```